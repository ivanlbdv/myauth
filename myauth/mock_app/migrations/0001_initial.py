# Generated by Django 5.2.10 on 2026-02-03 22:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='mock_app.post', verbose_name='Пост')),
            ],
            options={
